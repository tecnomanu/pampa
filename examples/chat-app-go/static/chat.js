/**
 * PAMPA Chat - Cliente JavaScript para Go
...
class ChatClient {
    ...
    async connectWebSocket() {
        // Go WebSocket server runs on port 8082
        ...
        try {
            ...
            this.ws.onopen = () => {
                console.log('Conectado al servidor WebSocket Go');
            ...
            this.ws.onclose = () => {
                console.log('Desconectado del servidor WebSocket Go');
                this.isConnected = false;
    ...
    loadRooms() {
        // Simular carga de salas para Go
        const defaultRooms = [
            { id: 'general', name: 'General', description: 'Sala principal' },
            { id: 'go', name: 'Go', description: 'Todo sobre Go' },
