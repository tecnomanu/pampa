/**
 * PAMPA Chat - Cliente JavaScript para Java
...
class ChatClient {
    ...
    async connectWebSocket() {
        // Java WebSocket server runs on port 8083
        ...
        try {
            ...
            this.ws.onopen = () => {
                console.log('Conectado al servidor WebSocket Java');
            ...
            this.ws.onclose = () => {
                console.log('Desconectado del servidor WebSocket Java');
                this.isConnected = false;
    ...
    loadRooms() {
        // Simular carga de salas para Java
        const defaultRooms = [
            { id: 'general', name: 'General', description: 'Sala principal' },
            { id: 'java', name: 'Java', description: 'Todo sobre Java y Spring' },
